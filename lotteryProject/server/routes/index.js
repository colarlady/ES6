...
var makeIssue =function(){
    ...
    if(date.getTime()-first_issue_date.getTime()>0 && date.getTime()-end_issue_date.getTime()<0){
      ...
      var minus_time = date.getTime()-first_issue_date.getTime();
      ...
      //今天销售已截止
          ...
          cur_issue = [first_issue_date.getFullYear(),('0'+(first_issue_date.getMonth()+1)).slice(-2),('0'+end_date.getDate()).slice(-2),'01'].join('');
