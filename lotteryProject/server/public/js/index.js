...
/***/ (function(module, exports, __webpack_require__) {
	...
	var syy = new _lottery2.default(); //项目入口文件
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calculate = __webpack_require__(6);
	...
	var Lottery = function (_mix) {
	    ...
	    _createClass(Lottery, [{
	        ...
	        value: function updateState() {
	            ...
	            this.getState().then(function (res) {
	                ...
	                self.countdown(res.end_time, function (time) {
	                    (0, _jquery2.default)(self.countdown_el).html(el);
	                }, function () {
	                    setTimeout(function () {
	                        self.updateState();
	        ...
	        value: function initEvent() {
	            ...
	            (0, _jquery2.default)('.boll-list').on('click', 'btn-boll', self.toggleCodeActive.bind(selfS));
	            (0, _jquery2.default)('#confirm_self_code').on('click', self.addCode.bind(self));
	            (0, _jquery2.default)('.dxjo').on('click', self.assistHandle.bind(self));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //跟彩种相关的基本信息的存储
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function toggleCodeActive(e) {
	            var self = this;
	            var $cur = (0, _jquery2.default)(e.currentTagrget);
	        ...
	        value: function getRandomCode(e) {
	            e.preventDefault();
	            var num = e.currentTagrget.getAttribute('count');
	            ...
	            if (play[0] === 'r') {
	                ...
	                if (min_active > 0) {
	                    if (min_active - play[1] > 0) {
	                        arr = new Array(min_active).length;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //所有的接口的集合
	...
	var Timer = function () {
	    ...
	    _createClass(Timer, [{
	        ...
	        value: function (_countdown) {
	            ...
	            //计时
	            var now = new Date().getTime(); //当前事件
	            var self = this; //记录this指向
	            if (now - end > 0) {
	                //如果当前已经到结束事件
	                handle.call(this);
	            } else {
